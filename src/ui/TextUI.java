...
public class TextUI {
    ...
    public void letsGo (PaySysApp app) throws IOException {
        System.out.print("Welcome to the PayRoll Team Login Interface\n");
        System.out.println("Select One Of The Options Below\n");
        System.out.println("\n1) Generate Payslip \n2) Review Employee History \n3) Generate Report \n5) Exit");

        Scanner payRoll = new Scanner(System.in);
        try {
            int select = payRoll.nextInt();
            ...
            while (select != 5) {
                ...
                System.out.print("\nWelcome to the PayRoll Team Login Interface\n");
                System.out.println("Select One Of The Options Below\n");
                System.out.println("\n1) Generate Payslip \n2) Review Employee History \n3) Generate Report \n5. Exit");

                select = payRoll.nextInt();
            }
